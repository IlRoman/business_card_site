...
const experienceArray = [
    {
        ...
        technologies: "HTML5, CSS (3+), SCSS, JavaScript (ES6+), React, Redux, Redux saga, Web sockets, BEM Methodology, Git, REST API, npm, Trello",
    ...
    },
    {
        ...
        technologies: "HTML5, Tailwind, JavaScript (ES6+), React, Gatsby, MobX, 'Typescript, Git, GraphQL, npm, PWA, Jira",
        responsibilities: "Create pages of PWA application and logic on frontend making different requests to the server.",
    },
    {
        date: "2020 - 2020",
        description: "Application for finding speakers and finding customers.",
        technologies: "HTML5, Styled Components, JavaScript (ES6+), React, Redux, BEM Methodology, Git, REST API, npm, Trello, React-Slick, Libraries for React-animations",
        responsibilities: "Create pages of PWA application and logic on frontend making different requests to the server.",
    },
    {
        date: "2019 - 2020",
        description: "Application for tourists visiting London.",
        technologies: " HTML5, CSS (3+), SCSS, JavaScript (ES6+), React, Redux, BEM Methodology, Git, REST API, npm, Trello, Next.js, Styled Component, Material-UI",
    ...
    },
    {
        ...
        technologies: "HTML5, CSS (3+), Bootstrap, JavaScript (ES6+), React, Redux, Formik, 'Material UI', BEM Methodology, Git, REST API, npm",
        responsibilities: "Create pages of application and logic on frontend making different requests to the server",
    },
    {
        date: "2018- 2019",
        description: "The site of a company providing fitness services. People who  register on the site and keep their fitness-diaries under the supervision of a trainer",
        technologies: "HTML5, SCSS, JavaScript (ES6+), React, Redux, Formik, BEM Methodology, Git, REST API, npm",
        responsibilities: "Create pages of application and logic on frontend making different requests to the server",
    },
    {
        date: "2017 - 2018",
        ...
        technologies: "HTML5, Module CSS, JavaScript (ES6+), React, Redux, TypeScript, BEM Methodology, Git, REST API, npm, Trello, React-toprint and other libraries",
        responsibilities: "Create pages of application and logic on frontend making different requests to the server.",
    },
];
