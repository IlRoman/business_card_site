...
export const Modal = ({ children, title, subtitle, close }) => {
  ...
  const customModalClasses = classNames(
    "custom-modal",
    animation && "custom-modal_animated"
  );
  const customModalContainerClasses = classNames(
